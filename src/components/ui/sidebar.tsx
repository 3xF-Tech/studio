...
>(({ className, ...props }, ref) => {
  ...
  if (isMobile) {
    return (
      <SheetPrimitiveTrigger ref={ref} asChild>
        <Button
          variant="ghost"
          size="icon"
